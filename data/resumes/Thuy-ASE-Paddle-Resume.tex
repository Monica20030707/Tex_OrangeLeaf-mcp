...
\begin{itemize}
  ...
  \item Translated technical specifications into business value for diverse customer segments, acting as a primary technical point of contact for strategic partners.
\end{itemize}

\textbf{Associate Full Stack Developer,} {Forge Tek Studios} -- Remote \hfill August 2025 -- Current 
\vspace{-9pt}
\begin{itemize}
  \item Built and deployed a production-ready full-stack React application, integrating external APIs (Steam, Fab Marketplace) to dynamically render real-time content.
  ...
  \item Managed the full production release lifecycle, including environment configs and API integrations, ensuring a reliable experience for end-users.
\end{itemize}

\textbf{Full Stack Developer Intern,} {METY Technology} -- Remote \hfill September 2024 -- June 2025 
\vspace{-9pt}
\begin{itemize}
  \item Developed secure and scalable RESTful APIs with Express.js and Node.js to manage complex data flows and backend communication.
  \item Architected a robust state management layer using Redux Toolkit and built responsive visual feedback systems with React and Tailwind CSS.
  \item Enhanced user engagement by 25\% through the development of highly intuitive, real-time interactive features and interaction-driven UI feedback.
\end{itemize}
...
\vspace{-9pt}
\begin{itemize}
  \item Architected the data-flow pipeline connecting Python backend calculations to a live React dashboard, ensuring stable, low-latency ratio updates via API integrations. 
...
\vspace{-9pt}
\begin{itemize}
  \item Engineered an automated notification system processing license plate images through SQS and EventBridge, ensuring reliable data routing and external service communication.
  \item Designed a high-reliability workflow that integrates image processing APIs with cloud messaging services to deliver real-time user notifications.
\end{itemize}
...
% skills section
\section*{Skills}
\textbf{Languages:} JavaScript (ES6+), TypeScript, Node.js, Python, Java, SQL, HTML/CSS\\
\textbf{Technologies:} React, Express.js, RESTful APIs, AWS (S3, SQS, EventBridge), Redux Toolkit, Tailwind CSS\\
\textbf{Interpersonal:} Technical Consulting, Consultative Selling, Solution Architecture, Cross-functional Collaboration\\
