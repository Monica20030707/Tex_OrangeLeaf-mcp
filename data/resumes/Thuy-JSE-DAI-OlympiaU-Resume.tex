...
% skills section
\section*{Skills}
\textbf{Languages:} Python, SQL (MySQL, PostgreSQL), Java, C++, TypeScript, JavaScript, Go, PHP, HTML/CSS\\
\textbf{Skills:} Data Engineering Fundamentals, APIs and Data Flow, AI and Generative AI, Full-stack, SQL\\
\textbf{Tools:} Spark/PySpark (Familiar), NumPy, TensorFlow.js, React, Redux Toolkit, AWS Cloud Services, Docker, Git\\
