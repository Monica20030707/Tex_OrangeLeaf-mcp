...
\vspace{-9pt}
\begin{itemize}
  \item Explain technical concepts, such as bandwidth needs, signal strength, coverage maps, and device compatibility, to help customers make informed decisions and solve complex business problems.
  ...
  \item Translated technical specifications into tangible business value for diverse customer segments, building long-term trust and strategic partnerships.
\end{itemize}

\textbf{Associate Full Stack Developer,} {Forge Tek Studios} -- Remote \hfill August 2025 -- Current 
\vspace{-9pt}
\begin{itemize}
  \item Built and deployed a production-ready full-stack component-driven React application, integrating external APIs to dynamically render real-time content for end-users.
  \item Reduced system load and data ingestion overhead by 80\% through optimization of client-side rendering and synchronization logic, focusing on performance-sensitive UI updates.
  \item Owned the end-to-end development and deployment lifecycle, ensuring high standards for code quality, scalability, and user experience.
\end{itemize}

\textbf{Full Stack Developer Intern,} {METY Technology} -- Remote \hfill September 2024 -- June 2025 
\vspace{-9pt}
\begin{itemize}
  \item Engineered a real-time, interaction-driven application using React and TensorFlow.js (MoveNet), processing live camera input and rendering responsive visual feedback.
  \item Enhanced user engagement by 25\% through the development of highly responsive and intuitive real-time interaction systems.
  \item Automated testing and deployment processes via a custom CI/CD pipeline on AWS Amplify, ensuring consistent delivery and high quality standards.
\end{itemize}
...
\vspace{-9pt}
\begin{itemize}
  \item Architected a data-flow pipeline connecting Python backend calculations to a live React dashboard for real-time monitoring of financial ratios.
  \item Used JPMorgan Chase’s Perspective library to generate live, interactive visualizations of complex data feeds for clear decision-making.
  \item Implemented automated unit tests to ensure high data integrity and reliability of technical calculations.
\end{itemize}
...
\vspace{-9pt}
\begin{itemize} 
  \item Built an Artificial Neural Network (ANN) from scratch to classify handwritten digits, demonstrating a deep understanding of machine learning foundations and algorithm implementation. 
  \item Achieved over 90\% accuracy using the Backpropagation algorithm, optimized through NumPy vectorization for computational efficiency.
\end{itemize}
...
% skills section
\section*{Skills}
\textbf{Languages:} Python, Go, TypeScript, Java, Kotlin, C++, Next.js, JavaScript, MySQL, Tailwind CSS\\
\textbf{Skills:} Consultative Selling, Technical Presentations, RESTful APIs, Machine Learning (ML), Full-stack, Collaboration\\
\textbf{Tools:} Gen AI/ML, React, Redux Toolkit, Docker, Jira, AWS Cloud Services, TensorFlow.js, NumPy\\
