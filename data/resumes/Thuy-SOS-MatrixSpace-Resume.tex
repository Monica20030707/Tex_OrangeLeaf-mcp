...
\begin{itemize}
  ...
  \item Conducted hardware diagnostics and firmware validation on mobile devices and networking equipment to ensure optimal performance.
...
% skills section
\section*{Skills}
\textbf{Languages:} Python, Bash, TypeScript, JavaScript, SQL, HTML, CSS\\
\textbf{Skills:} Technical Troubleshooting, Networking (TCP/IP, DNS), REST APIs, JSON, CI/CD, Linux Administration\\
\textbf{Tools:} Docker, Kubernetes, AWS (S3, SQS, Rekognition), Git, Raspberry Pi, React, Node.js\\
