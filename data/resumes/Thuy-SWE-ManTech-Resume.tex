...
\begin{itemize}
  ...
  \item Implemented dynamic data fetching and caching strategies for third-party APIs to reduce latency and improve system responsiveness.
  \item Managed the full production release lifecycle, ensuring high standards for code quality and performance-sensitive UI updates.
\end{itemize}

\textbf{Full Stack Developer Intern,} {METY Technology} -- Remote \hfill September 2024 -- June 2025 \\
\vspace{-9pt}
\begin{itemize}
  \item Architected a secure backend using Express.js and Node.js with a robust state management layer using Redux Toolkit to ensure data integrity.
  ...
  \item Integrated real-time machine learning models with React to enable low-latency user interaction directly in the browser.
\end{itemize}

\textbf{Open-Source Intern,} {CodeDay} -- Seattle, WA \hfill April 2025 -- May 2025 \\
\vspace{-9pt}
\begin{itemize}
  \item Orchestrated Docker-based development environments to ensure consistent application behavior across local and staging environments.
  \item Authored comprehensive database integration tests to resolve high-priority open-source tickets and prevent regression in internal systems.
  \item Facilitated daily stand-ups and retrospectives as Scrum Master, aligning cross-functional teams on technical requirements and project goals.
\end{itemize}
...
\vspace{-9pt}
\begin{itemize}
  \item Built a Python-based data ingestion and transformation layer to feed live financial metrics into a React frontend, ensuring stable and low-latency updates.
  \item Optimized real-time data streaming and state synchronization between Python processes and Perspective visualization components for clear data monitoring.
\end{itemize}
...
\vspace{-9pt}
\begin{itemize}
  \item Architected an event-driven serverless pipeline on AWS, integrating Rekognition for image analysis and SQS for decoupled message processing to ensure data safety.
  \item Implemented pattern matching with Regex to filter geographic plate data, ensuring accurate routing and notice generation for automated violation detection.
\end{itemize}
...
% skills section
\section*{Skills}
\textbf{Languages:} Python, TypeScript, JavaScript, SQL, Bash, Java, C++, HTML, CSS\\
\textbf{Skills:} Full-stack Development, API Integration, Database Testing, Docker, CI/CD, Agile/Scrum\\
\textbf{Tools:} React, Node.js, AWS (S3, SQS, Rekognition, Amplify), Redux Toolkit, Git, Jest, ESLint\\
