...
\vspace{-9pt}
\begin{itemize}
  \item Converted \textbf{75\%} of prospects through consultative selling, generating \textbf{110--130\%} quota attainment while maintaining trusted customer relationships.
  \item Resolved \textbf{70\%} of sales through technical device troubleshooting, using diagnostics tools and firmware checks to recommend data-backed product upgrades.
  \item Explained complex technical concepts like signal strength, coverage, and device compatibility to SMB customers, enabling informed purchase decisions and technical confidence.
\end{itemize}
...
\vspace{-9pt}
\begin{itemize}
  \item Integrated real-time MoveNet ML models with React, processing \textbf{30 FPS} live camera streams with \textbf{<50ms latency} for gesture recognition.
...
\vspace{-9pt}
\begin{itemize}
  \item Processed license plate images from S3 using AWS Rekognition, automating identification of traffic offenders and routing events through SQS and EventBridge.
...
\vspace{-9pt}
\begin{itemize}
  \item Developed an automated pipeline generating tailored resumes and cover letters from a versioned YAML data store using \textbf{LLM-driven content selection}.
  \item Engineered a CI/CD workflow using GitHub Actions to compile LaTeX source into production-ready PDFs upon every push.
  \item Created a modular data-injection system that dynamically pivots content (technical, impact, leadership) to match specific role requirements -- demonstrating \textbf{prompt engineering} and content personalization.
\end{itemize}
...
\textbf{Technologies:} React, Express.js, RESTful APIs, AWS (S3, SQS, EventBridge, Rekognition, SES), Node.js, Git, GitHub Actions\\
\textbf{Interpersonal:} Technical Pre-Sales, Consultative Selling, Solution Architecture, Cross-functional Collaboration, Customer Success
