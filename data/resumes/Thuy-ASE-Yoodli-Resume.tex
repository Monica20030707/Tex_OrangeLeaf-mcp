...
\textbf{Skills:} React, Express.js, RESTful APIs, AWS (S3, SQS, EventBridge, Rekognition, SES), Node.js, Git, Technical Pre-Sales, Consultative Selling\\
\textbf{Tools:} GitHub Actions
