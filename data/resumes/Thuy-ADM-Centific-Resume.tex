...
\begin{itemize}
  ...
  \item Took ownership of inventory management and hardware validation cycles, ensuring 100\% accuracy in stock records and device readiness for participant use.
\end{itemize}
...
\begin{itemize}
  ...
  \item Built and maintained a CI/CD pipeline using AWS Amplify, with automated testing via Jest and code quality enforcement through ESLint to ensure data integrity.
\end{itemize}

\textbf{Front Desk Assistant} {, Public Safety Department, Bellevue College} -- Bellevue, WA \hfill June 2023 -- August 2023 \\
\vspace{-9pt}
\begin{itemize}
  \item Managed campus security data and documentation using Excel and advanced Outlook scheduling tools with high attention to detail.
  \item Improved administrative efficiency by organizing digital records and streamlining visitor check-in processes for on-site participants.
  \item Coordinated with public safety officers to manage campus-wide communication and logistics, ensuring accurate data handling under FERPA guidelines.
\end{itemize}
...
\begin{itemize}
  ...
  \item Automated the violation detection and notification workflow, reducing manual processing time by over 90\% through accurate license plate identification.
\end{itemize}

\textbf{MNIST Handwritten Digit Classifier}{ - Python, NumPy Library} \hfill \href{https://github.com/Monica20030707/Artificial-Neutral-Network_ML}{github.com} \\
\vspace{-9pt}
\begin{itemize} 
  \item Engineered a multi-layer perceptron architecture from scratch, implementing forward and backward propagation to classify handwritten digits (0-9). 
  \item Attained 90\%+ classification accuracy on the standard MNIST benchmark, verifying model correctness and deep understanding of machine learning fundamentals.
\end{itemize}
...
% skills section
\section*{Skills}
\textbf{Data \& Operations:} Data Moderation, Data Collection, MS Office (Excel, Word, Outlook), Device Troubleshooting\\
\textbf{AI/ML Skills:} TensorFlow.js, AWS Rekognition, Neural Networks, Data Labeling, Quality Assurance\\
\textbf{Tools:} CRM (Salesforce), Inventory Management, Git, AWS Cloud Services, React, Python, JavaScript\\
