...
\begin{itemize}
  ...
  \item Collaborated on design and architecture decisions, advocating for serverless solutions to meet scalability and cost requirements for high-performance web applications.
...
\textbf{Traffic Violation Detection System}{ - AWS Services, JavaScript} \hfill \href{https://github.com/Monica20030707/AWS_rekonigition-N-read-database}{github.com} \\
\vspace{-9pt}
\begin{itemize}
...
\vspace{-9pt}
\begin{itemize}
  \item Increased trader decision-making efficiency by 40\% through the design of an intuitive, real-time dashboard visualizing financial metrics.
  \item Evaluated and selected industry-standard financial visualization tools to deliver a production-quality dashboard experience.
...
\textbf{Skills:} AWS Cloud Computing, Consultative Sales, Lead Qualification, CRM, Cloud Architecture, AI/ML\\
\textbf{Tools:} AWS (S3, SQS, EventBridge, Rekognition, Amplify), React, Node.js, Serverless, Git, Docker\\
