...
\vspace{-9pt}
\begin{itemize}
  \item Designed and deployed a serverless backend to keep costs low and servers flexible for high visitor traffic, managing the full production release lifecycle.
  \item Built and deployed a production-ready component-driven React application, integrating external APIs to dynamically render real-time content.
  \item Reduced system load and ingestion overhead by 80\% through optimization of client-side rendering and synchronization logic.
\end{itemize}
...
\begin{itemize}
  ...
  \item Engineered a real-time application using React and TensorFlow.js, processing live camera input and rendering responsive UI feedback.
...
\begin{itemize} 
  ...
  \item Diagnosed and resolved network routing conflicts to ensure zero-latency ad blocking and improved page load speeds by 30\%.
  \item Configured DNS services and network routing from scratch, verifying system stability through log inspection and connectivity testing.
\end{itemize}
...
% skills section
\section*{Skills}
\textbf{Languages:} Python, Go, TypeScript, Java, SQL, JavaScript, Linux (Shell), MySQL, Tailwind CSS\\
\textbf{Skills:} Cloud Computing, Sales Prospecting, Technical Troubleshooting, RESTful APIs, CRM (Salesforce), Full-stack\\
\textbf{Tools:} AWS Amplify, AWS Cloud Services, Serverless, React, Docker, Jira, Git, DNS, Pi-hole\\
