...
\vspace{-9pt}
\begin{itemize}
  \item Converted \textbf{75\% of prospects} into customers through consultative selling, generating \textbf{110-130\% quota attainment} while maintaining strong customer relationships.
...
\vspace{-9pt}
\begin{itemize}
  \item Reduced system load by \textbf{80\%} and lowered page load from 3.2s to 0.8s, increasing \textbf{conversion rates by 35\%} across high-traffic product pages.
  \item Delivered production application serving \textbf{5,000+ MAU} with \textbf{99.9\% uptime}, zero infrastructure downtime during daily Vercel deployments.
\end{itemize}
...
\begin{itemize}
  ...
  \item Supported a classroom of \textbf{40+ students}, ensuring all learners met course objectives and raising average assignment scores by 15\%.
\end{itemize}
...
\vspace{-9pt}
\begin{itemize}
  \item Automated the violation detection and notification workflow, reducing \textbf{manual processing time by over 90\%}.
...
\vspace{-9pt}
\begin{itemize}
  \item Reduced manual resume tailoring time by \textbf{90\%} by automating the data selection and document formatting process through an LLM-driven pipeline.
...
% skills section
\section*{Skills}
\textbf{Languages:} English, Vietnamese, Python, JavaScript, TypeScript, Java, SQL\\
\textbf{Skills:} Consultative Selling, SMB Relationship Management, Lead Generation, Cold Calling, Business Needs Analysis, Technical Troubleshooting, Data-Driven Sales, Time Management\\
\textbf{Tools:} CRM Platforms, POS Systems, Inventory Management, Revenue Analysis, React, AWS, GitHub Actions\\
