...
\begin{itemize}
  ...
  \item De-escalated complex technical issues by explaining bandwidth optimization, signal propagation, and network topology to non-technical customers and business partners.
...
\vspace{-9pt}
\begin{itemize}
  \item Managed the full production release lifecycle, including build pipelines, environment configs, DNS, and hosting to deliver a fully operational site for high visitor traffic.
  \item Architected a modular React frontend with a serverless backend, optimizing client-side rendering and data synchronization to reduce ingestion overhead by 80\%.
  \item Collaborated on design and architecture decisions, advocating for scalable solutions to meet demanding customer specifications and performance requirements.
\end{itemize}
...
\begin{itemize}
  ...
  \item Developed secure and scalable RESTful APIs to manage data flow and backend communication for interaction-driven applications.
\end{itemize}
...
\textbf{Traffic Violation Detection System}{ - AWS, Rekognition, JavaScript} \hfill \href{https://github.com/Monica20030707/AWS_rekonigition-N-read-database}{github.com} \\
\vspace{-9pt}
\begin{itemize}
  \item Architected an event-driven serverless pipeline on AWS, integrating Rekognition for image analysis and vision-based license plate identification.
  \item Automated the violation detection and notification workflow, reducing manual processing time by over 90\% and leveraging SQS for decoupled message processing.
\end{itemize}
...
\begin{itemize}
  ...
  \item Verified system behavior through log inspection, connectivity testing, and iterative configuration changes to ensure stable and reliable operation in home-lab environments.
\end{itemize}
...
\textbf{Skills:} Technical Troubleshooting, Consultative Selling, Customer Relationship Management, System Architecture\\
\textbf{Tools:} AWS Cloud Services (Rekognition, S3, SQS), Linux, Docker, React, Node.js, Serverless, Git, CRM\\
